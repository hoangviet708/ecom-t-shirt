  ...
  return (
    <div className="slideContainer">
      ...
      <div className="imageSilde">
        <img alt="" src={URL_SILDE_IMG_LEFT} className="img1" />
        <img alt="" src={URL_SILDE_IMG_MID} className="img2" />
        <img alt="" src={URL_SILDE_IMG_RIGHT} className="img3" />
      </div>
    </div>
  );
};
